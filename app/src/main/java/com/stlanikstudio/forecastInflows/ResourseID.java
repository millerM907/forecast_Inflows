...
public class ResourseID {
    ...
    public int getSearchImageResourseID(int percentTides){
        ...
        return context.getResources().getIdentifier(imageWaveName, "drawable", BuildConfig.APPLICATION_ID);
    }
    ...
    public int tv_waterResourseID(int identifier, String activityName){
        ...
        return context.getResources().getIdentifier(tv_water, "id", BuildConfig.APPLICATION_ID);
    }
    ...
    public int tv_timeResourseID(int identifier, String activityName){
        ...
        return context.getResources().getIdentifier(tv_time, "id", BuildConfig.APPLICATION_ID);
    }
    ...
    public int tv_heightResourseID(int identifier, String activityName){
        ...
        return context.getResources().getIdentifier(tv_height, "id", BuildConfig.APPLICATION_ID);
    }
    ...
    public int tv_tideResourseID(int identifier, String activityName){
        ...
        return context.getResources().getIdentifier(tv_tide, "id", BuildConfig.APPLICATION_ID);
    }


    public int but_dayResourseID(int identifier){
        String but_day = "but_day" + identifier;
        return context.getResources().getIdentifier(but_day, "id", BuildConfig.APPLICATION_ID);
    }

    public int tv_dayResourseID(int identifier){
        String tv_day = "tv_day" + identifier;
        return context.getResources().getIdentifier(tv_day, "id", BuildConfig.APPLICATION_ID);
    }
