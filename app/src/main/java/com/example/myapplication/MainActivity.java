...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView2.setBackgroundResource(resourseID.getSearchImageResourseID(percent));
        ...
        /*
        //в percent вернули %
        String percent = "10"; //String.valueOf(TimePercent.calculatePercentUntilEndCycle(tidesForFishingParserList.get(6), tidesForFishingParserList.get(2), tidesForFishingParserList.get(4)));
        ...
        //запускаем поток по отрисовке процентов
    ...
    class DataTask extends AsyncTask<List, Void, List> {

        @Override
        protected List doInBackground(List... unused) {
            return TidesForFishingParser.getTidesForFishingDataList();
        }

        @SuppressLint("SetTextI18n")
        @Override
        protected void onPostExecute(List tidesForFishingParserLis) {
            //super.onPostExecute(tidesForFishingParserLis);
            List<String> tidesForFishingParserList = tidesForFishingParserLis;
